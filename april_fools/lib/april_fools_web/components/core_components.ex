defmodule AprilFoolsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AprilFoolsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AprilFoolsWeb.Gettext, "errors", msg, opts)
    end
  end
